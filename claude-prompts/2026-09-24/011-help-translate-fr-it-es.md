# Help translation: French, Italian, Spanish (fr, it, es)

## Goal
Translate the whole Help center into **French, Italian, Spanish**: every article, every tip,
the checklist titles, the UI strings and the topic names. Then add
`fr`, `it`, `es` to `HELP_LOCALES`.
...
## Scope
- **In:** `help/fr/**`, `help/it/**`, `help/es/**`, and
...
- **One commit per language:**
  ...
  claude-prompts/2026-09-24/011-help-translate-fr-it-es.md`.
- **Push now.** No deploy (Ammar deploys after all languages).

## Report
`claude-reports/2026-09-24/011-help-translate-fr-it-es.md`, half a page:
