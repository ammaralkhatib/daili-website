# Help translation: Portuguese (Brazil, as the app), Polish, Czech (pt, pl, cs)

## Goal
Translate the whole Help center into **Portuguese (Brazil, as the app), Polish, Czech**: every article, every tip,
the checklist titles, the UI strings and the topic names. Then add
`pt`, `pl`, `cs` to `HELP_LOCALES`.
...
## Scope
- **In:** `help/pt/**`, `help/pl/**`, `help/cs/**`, and
...
- Portuguese: the app's `app_pt.arb` looks Brazilian (check it). Follow whatever it uses.
...
- **One commit per language:**
  ...
  claude-prompts/2026-09-24/012-help-translate-pt-pl-cs.md`.
- **Push now.** No deploy (Ammar deploys after all languages).

## Report
`claude-reports/2026-09-24/012-help-translate-pt-pl-cs.md`, half a page:
