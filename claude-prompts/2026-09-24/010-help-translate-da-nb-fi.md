# Help translation: Danish, Norwegian (Bokmål), Finnish (da, nb, fi)

## Goal
Translate the whole Help center into **Danish, Norwegian (Bokmål), Finnish**: every article, every tip,
the checklist titles, the UI strings and the topic names. Then add
`da`, `nb`, `fi` to `HELP_LOCALES`.
...
## Scope
- **In:** `help/da/**`, `help/nb/**`, `help/fi/**`, and
...
- **One commit per language:**
  ...
  claude-prompts/2026-09-24/010-help-translate-da-nb-fi.md`.
- **Push now.** No deploy (Ammar deploys after all languages).

## Report
`claude-reports/2026-09-24/010-help-translate-da-nb-fi.md`, half a page:
