...
![Ay görünümünde takvim. Sağ alttaki + düğmesi daire içine alınmış.](calendar-add-event)

1. **Takvim** ekranını aç ve sağ alttaki yuvarlak **+** düğmesine dokun.
2. **Başlık** alanına bir başlık yaz.
