...
title: Ulož recept z odkazu na web
summary: Vlož odkaz na stránku s receptom a daili za teba vyplní suroviny, postup a fotku.
...
![Obrazovka Recepty s otvorenou ponukou +. Zakrúžkovaný je Importovať z odkazu.](meals-import-link)

1. Skopíruj odkaz na stránku s receptom.
2. Na domovskej obrazovke ťukni na **Recepty**, potom na **+** a potom na **Importovať z odkazu**.
3. Vlož odkaz do poľa **Odkaz na recept** alebo ťukni na **Vložiť**. Potom ťukni na **Importovať**.
4. Skontroluj, čo daili našlo, a oprav, čo nesedí. Potom ťukni na **Uložiť**.
