...
title: Zapisz przepis z linku do strony
summary: Wklej link do strony z przepisem, a daili samo uzupełni składniki, kroki i zdjęcie.
...
![Ekran Przepisy z otwartym menu +. Zakreślona jest opcja Importuj z linku.](meals-import-link)

1. Skopiuj link do strony z przepisem.
2. Na ekranie głównym dotknij **Przepisy**, potem **+**, a potem **Importuj z linku**.
3. Wklej link w polu **Link do przepisu** albo dotknij **Wklej**. Potem dotknij **Importuj**.
4. Sprawdź, co znalazło daili, i popraw to, co się nie zgadza. Potem dotknij **Zapisz**.
