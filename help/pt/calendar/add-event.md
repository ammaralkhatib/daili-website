...
![O calendário na visualização Mês. O botão + no canto inferior direito está circulado.](calendar-add-event)

1. Abra o **Calendário** e toque no botão redondo **+**, no canto inferior direito.
2. Digite um **Título**.
