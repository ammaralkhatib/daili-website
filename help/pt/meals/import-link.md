...
title: Salvar uma receita a partir de um link
summary: Cole o link de uma página de receita, e o daili preenche os ingredientes, os passos e a foto para você.
...
![A tela Receitas com o menu + aberto. Importar de um link está circulado.](meals-import-link)

1. Copie o link da página da receita.
2. Na tela inicial, toque em **Receitas**, depois em **+** e depois em **Importar de um link**.
3. Cole o link em **Link da receita**, ou toque em **Colar**. Depois toque em **Importar**.
4. Confira o que o daili encontrou e corrija o que estiver errado. Depois toque em **Salvar**.
