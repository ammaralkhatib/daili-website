...
title: Een recept bewaren via een link naar een website
summary: Plak een link naar een receptpagina, en daili vult de ingrediënten, stappen en foto voor je in.
...
![Het scherm Recepten met het menu + open. Importeren via link is omcirkeld.](meals-import-link)

1. Kopieer de link naar de receptpagina.
2. Tik op het startscherm op **Recepten**, dan op **+** en dan op **Importeren via link**.
3. Plak de link onder **Receptlink**, of tik op **Plakken**. Tik dan op **Importeren**.
4. Controleer wat daili heeft gevonden en verbeter wat niet klopt. Tik dan op **Opslaan**.
