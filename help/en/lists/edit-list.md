...
id: lists-edit-list
topic: lists
title: Rename, recolour, reorder or delete a list
summary: Give a list a new name, colour or icon, drag your lists into order, or delete one you don't need.
keywords: rename, edit list, colour, color, icon, reorder, sort lists, delete list, remove list
