...
title: Spara ett recept från en länk till en webbplats
summary: Klistra in en länk till en receptsida, så fyller daili i ingredienser, steg och foto åt dig.
...
![Skärmen Recept med menyn + öppen. Importera från länk är inringat.](meals-import-link)

1. Kopiera länken till receptsidan.
2. Tryck på **Recept** på startskärmen, sedan på **+** och på **Importera från länk**.
3. Klistra in länken under **Receptlänk**, eller tryck på **Klistra in**. Tryck sedan på **Importera**.
4. Kontrollera det daili hittade och rätta det som inte stämmer. Tryck sedan på **Spara**.
